...
$clia ObjectRegistry updatePermissionTemplate objectRegistry=udo_Route templatePrimaryOwnerGroup='Locations Admin' templatePrimaryOwnerCrud=Create,Read,Update,Delete templateGroupOwnerGroup='All Users' templateGroupOwnerCrud=Read